...
class Ui_Dialog4(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(526, 413)
        self.verticalLayoutWidget = QtWidgets.QWidget(Dialog)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(190, 40, 235, 341))
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(70, 50, 110, 271))
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "新建日常任务"))
        ...
        self.label_5.setText(_translate("Dialog", "起始时间："))
